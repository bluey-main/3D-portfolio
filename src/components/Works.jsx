...
const ProjectCard = ({ index, name, description, tags, image, source_code_link, website }) => {
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 1.3)}>
      <Tilt
        options={{ max: 45, scale: 1, speed: 450 }}
        className="bg-tertiary p-5 rounded-2xl lg:w-[360px] sm:w-[300px] w-full"
      >
    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          links to code repositories and live demos in it's respective github
          repository.
        </motion.p>
      </div>
